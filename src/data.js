import { MdElectricBolt, MdAutorenew, MdSecurity, MdHomeRepairService, MdViewList, MdEvent } from 'react-icons/md'
...
export const serviceList = [
    ...
    },
    {
        ...
        content: "Innovative embedded solutions for automation and electronics",
        items: [
...
export const adminRoute = [
    ...
    { path: 'event', name: "Events", icon: MdEvent }
]