...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className='bg-white rounded-lg shadow-lg flex flex-col justify-between relative'>
            ...
            {
                product.soldOut && <p className='absolute top-0 bg-red-700/80 px-3 py-2 text-white'>Out of stock</p>
            }
        </div>
    )
}
